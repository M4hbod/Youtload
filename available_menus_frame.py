...
class AvailableMenuFrames():
    ...
    def __init__(self, master, text_font, tabs_font):
        ...
        self.download_button = ctk.CTkButton(self.options_frame, image=self.download_icon, compound='left', text="Downloads", corner_radius=15, width=40, font=text_font, fg_color='#343638', command=lambda : self.content.toggleFrame("downloads"))
        self.download_button.grid(row=2, column=0, padx=5, pady=5)


        self.settings_button = ctk.CTkButton(self.options_frame, image=self.settings_icon, compound='left', text="Settings", corner_radius=15, width=40, font=text_font, fg_color='#343638', command=lambda : self.content.toggleFrame("settings"))
